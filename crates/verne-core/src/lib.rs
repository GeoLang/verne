...
pub use sidecar::{
    ATTACHMENTS_DIR, Action, AttachmentOp, DatasetPlan, DeleteAttachment, DeleteFeature,
    ExtractionLog, FEATURES_DIR, FeatureOp, GEOPACKAGE_FILE, LogCounts, LogEntry,
    MAX_FEATURE_BYTES, NewAttachment, NewDataset, NewDomain, NewFeature, NewField, NewRelationship,
    NewSchema, NewSubtype, SIDECAR_FILE, Sidecar, UpdateFeature, safe_file_name,
};
